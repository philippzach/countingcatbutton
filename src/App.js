...
function getAppContent(count, countTotal, isClicked, handleClick) {
  ...
  <span>
	...
	<path class="st2" d="M184.75,109.069c-12.115,8.496-26.808,11.886-26.808,11.886c7.612,1.564,30.304-6.388,30.304-6.388
		...
		<ellipse transform="matrix(0.9997 0.0264 -0.0264 0.9997 3.6368 -1.1543)" class="st5" cx="45.509" cy="137.074" rx="18.577" ry="6.405"/>
	
		<ellipse transform="matrix(0.9948 -0.1016 0.1016 0.9948 -12.5703 16.736)" class="st5" cx="157.943" cy="131.719" rx="18.577" ry="6.407"/>
	<g class="st3">
